...
public class CookingTest {
    public static void main(String[] args) {
        ...
        Cooking cookingFishNChips = new Cooking(gameTime, "recipe_1", firewood);
        ...
        Cooking cookingBaguette = new Cooking(gameTime, "recipe_2", coal);
        ...
        Cooking cookingNoFuel = new Cooking(gameTime, "recipe_1", null);
        ...
        Cooking cookingNoIngredients = new Cooking(gameTime, "recipe_3", firewood);
