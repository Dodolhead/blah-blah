...
public class FishingTest {
    public static void main(String[] args) {
        ...
        Fishing fishingPond = new Fishing(gameTime, "Pond");
        ...
        Fishing fishingLake = new Fishing(gameTime, "Mountain Lake");
        ...
        Fishing fishingInvalid = new Fishing(gameTime, "Village");
