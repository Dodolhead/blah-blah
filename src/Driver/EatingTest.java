...
public class EatingTest {
    public static void main(String[] args) {
        ...
        System.out.println("\n==== MAKAN BAGUETTE (FOOD) ====");
        EatingAction eatBread = new EatingAction(gameTime, breadItem);
        ...
        System.out.println("\n==== MAKAN PARSNIP (CROP) ====");
        EatingAction eatParsnip = new EatingAction(gameTime, parsnipItem);
        ...
        System.out.println("\n==== MAKAN SARDINE (FISH) ====");
        EatingAction eatFish = new EatingAction(gameTime, fishItem);
