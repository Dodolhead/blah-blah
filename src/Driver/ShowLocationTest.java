...
public class ShowLocationTest {
    public static void main(String[] args) {
        ...
        ShowLocationAction showLocationFarm = new ShowLocationAction(farmMap);
        ...
        if (pondPosition != null) {
            ...
            showLocationFarm = new ShowLocationAction(farmMap);
        ...
        ShowLocationAction showLocationLake = new ShowLocationAction(farmMap);
        ...
        ShowLocationAction showLocationStore = new ShowLocationAction(farmMap);
