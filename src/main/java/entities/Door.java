...
public class Door extends Furniture {
    ...
    public Door() {
        super(
            "door",
            "Door",
            "A door that leads to another place.",
            1, 1, 'D',
            loadDoorImage(),
            new Gold(70)
        );
    ...
    private static BufferedImage loadDoorImage() {
        try {
            return ImageIO.read(Door.class.getResourceAsStream("/res/items/furniture/door.png"));
